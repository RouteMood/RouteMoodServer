...
class VideoStreamingServiceTest {
    ...
    void testPrepareContent_FileNotFound() throws IOException {
        ...
        ResponseEntity<Resource> response = videoStreamingService.prepareContent(id, new HttpHeaders());
    ...
    void testPrepareContent_FullContent() throws IOException {
        ...
        ResponseEntity<Resource> response = videoStreamingService.prepareContent(id, headers);
